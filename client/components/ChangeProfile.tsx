    ...
    <div>
      {
        loading ?
          ...
          <>
            ...
            <form method="post" onSubmit={handleChangeProfileData} className="formChangeProfileData">
              <div className="mb-3">
              ...
              <div className="mb-3">
                <label htmlFor="dateOfBirth" className="form-label">Datum rođenja:</label>
                <input
                  type="date"
                  name="dateOfBirth"
                  id="dateOfBirth"
              ...
              <div className="mb-3">
                <button className="btn btn-primary" id="buttonSave">Spremi</button>
                <a href="/profile" className="btn btn-primary text-end">Natrag</a>  
              </div>
            </form>
          </>
      }
